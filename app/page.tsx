    ...
    <div className="min-h-screen bg-white text-slate-900">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="leading-tight">
                <p className="text-xl font-bold tracking-tight">
                  <span className="bg-gradient-to-r from-teal-700 via-cyan-600 to-blue-700 bg-clip-text text-transparent">
                    GaMa
                  </span>
                  <span className="ml-1 text-teal-700">Indie</span>
                </p>
              </div>
            </div>
          </div>
      ...
      <main>
        <section className="relative overflow-hidden">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(13,148,136,0.12),_transparent_35%),radial-gradient(circle_at_bottom_right,_rgba(20,184,166,0.10),_transparent_30%)]" />
        ...
        <section id="contact" className="mx-auto max-w-7xl px-6 py-20">
          <div className="rounded-[2rem] bg-teal-700 px-8 py-14 text-white shadow-2xl shadow-teal-100 md:px-12">
            <div className="grid gap-10 md:grid-cols-[1.1fr_0.9fr] md:items-start">
              ...
              <div className="rounded-[2rem] bg-white/95 p-8 text-slate-900 shadow-xl">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <a href="https://www.linkedin.com/company/gama-indie" target="_blank" rel="noreferrer" className="rounded-2xl bg-slate-100 p-5 transition hover:bg-slate-200/70">
